...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        classes = [
            ...
            {'type_id': '/index.php/vod/type/id/2.html', 'type_name': '反差淫荡'},
            {'type_id': '/index.php/vod/type/id/3.html', 'type_name': '内射高潮'},                                                           
            {'type_id': '/index.php/vod/type/id/9.html', 'type_name': '辣妹大奶'},
            {'type_id': '/index.php/vod/type/id/32.html', 'type_name': '国产自拍'},
            ...
            {'type_id': '/index.php/vod/type/id/52.html', 'type_name': '日本无码'},
